...
<input type="file" name="slbs" style="margin-left:30px;margin-top: 40px;"><br>
...
if(isset($_POST['submit'])){
	...
	$slbs=$_POST['slbs'];
	$slbs=basename($_FILES["slbs"]["name"]);
	$path="file/".$slbs;
	move_uploaded_file($_FILES["slbs"]["tmp_name"],$path);
	
	$sql="insert into syllabus (class,slbs) values('$class','$slbs')";
