...
<label for="" style="margin-left:30px;">Choose a Subject:</label>
...
<input type="file" name="data" style="margin-left:30px;margin-top: 40px;"><br>
...
if(isset($_POST['submit'])){
	...
	$sql="insert into notes (class,subject,data) values('$class','$subject','$data')";
