	...
	<form>
		...
		<table border="3" style=" border-collapse: collapse";>
			<tr>
				...
				<th style="padding:20px;font-size:15px;">Mobile No.</th>
				...
				<tr>
					...
					<td style="padding:20px;font-size:15px;"><a href="approvet.php ? id=<?php echo $row['id'];?>">Approve </a></td>
					<td style="padding:20px;font-size:15px;"><a href="cancelt.php ? id=<?php echo $row['id'];?>">Decline</a></td>
